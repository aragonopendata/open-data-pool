...
class UpdatePoolType extends AbstractType 
{ 
    ...
    */ 
	...
	{ 
        $builder
           ...
           ->add('dc_type',TextType::class,
            [
                'required' => true,
                'description' => "Es el dc:type de la vista que se quiere actualizar",
            ]
            );
    }
	...
	public function configureOptions(OptionsResolver $resolver)
	{
	    ...
	    $resolver->setDefaults(
            [
                ...
                'data_class' => 'ApiRest\AodPoolBundle\Entity\Update',
            ]
	    );
	}
}
