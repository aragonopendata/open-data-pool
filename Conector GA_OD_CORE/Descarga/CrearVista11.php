<?php
    ...
    define("CLAVE_LAT", "LAT");                                           //La calve que tiene la latitud de la coordenada
    define("CLAVE_LOG", "LOG");                                           //La clave que tiene la longitud de la coordenada
    define("CLAVE_NOM_ENLACE", "NOM_ENLACE");                             //La clave que tiene el nombre para poder hacer referencia a las páginas externas
