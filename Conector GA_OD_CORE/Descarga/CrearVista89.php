<?php
   $vista=89;
   define ("CLAVE_URI", "CAGENC");
   define ("CLAVE_MUN", "CODIGO_MUN");   //La clave que necesita para relacionarse con la vista 11 Datos Municipio
   define ("COD_MUN", "CMUNDO");         //La clave que tiene el codigo del municipio
   define ("COD_PRO", "CPRODO");         //La clave que tiene el codigo de la provincia.
