        ...
        if (! $arrayvacio) {
            ...
            switch ($cuantos) {
                case 1:
                    ...
                    break;
                case 2:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]));
                    break;
                case 3:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]));
                    break;
                case 4:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]), trim($filaCVS[$valorParseo[3]]));
                    break;
                case 5:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]), trim($filaCVS[$valorParseo[3]]), trim($filaCVS[$valorParseo[4]]));
                    break;
                case 6:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]), trim($filaCVS[$valorParseo[3]]), trim($filaCVS[$valorParseo[4]]), trim($filaCVS[$valorParseo[5]]));
                    break;
                case 7:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]), trim($filaCVS[$valorParseo[3]]), trim($filaCVS[$valorParseo[4]]), trim($filaCVS[$valorParseo[5]]), trim($filaCVS[$valorParseo[6]]));
                    break;
                case 8:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]), trim($filaCVS[$valorParseo[3]]), trim($filaCVS[$valorParseo[4]]), trim($filaCVS[$valorParseo[5]]), trim($filaCVS[$valorParseo[6]]), trim($filaCVS[$valorParseo[7]]));
                    break;
                case 9:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]), trim($filaCVS[$valorParseo[3]]), trim($filaCVS[$valorParseo[4]]), trim($filaCVS[$valorParseo[5]]), trim($filaCVS[$valorParseo[6]]), trim($filaCVS[$valorParseo[7]]), trim($filaCVS[$valorParseo[8]]));
                    break;
                case 10:
                    $valor = sprintf($valorIso, trim($filaCVS[$valorParseo[0]]), trim($filaCVS[$valorParseo[1]]), trim($filaCVS[$valorParseo[2]]), trim($filaCVS[$valorParseo[3]]), trim($filaCVS[$valorParseo[4]]), trim($filaCVS[$valorParseo[5]]), trim($filaCVS[$valorParseo[6]]), trim($filaCVS[$valorParseo[7]]), trim($filaCVS[$valorParseo[8]]), trim($filaCVS[$valorParseo[9]]));
                    break;
            }
        }
        return $valor;
