...
class Isonomia
{
	...
	*/
	...
	/**
	 * array head de la isnonomia (varibles a encontrar en el head del CSV)
 	*/
	...
	*/
	...
	/*	$isonomia = $this->DameIsonomia();
		...
		if (!$this->error) {
			...
			if (!$this->error) {
				//llamada a la funcion reursiva por todos los nodos y subnodos para encontrar las varibles de parseo
				$this->EscribeLog("CompruebaEsquema",  
	...
	*/
    ...
    /**
	 * Función que realiza el analisi orgánico de que el esquema es valido nodo nodo
	 */
